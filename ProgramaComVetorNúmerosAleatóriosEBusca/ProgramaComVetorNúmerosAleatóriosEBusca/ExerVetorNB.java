 ...
 */
package ProgramaComVetorNúmerosAleatóriosEBusca;
...
public class ExerVetorNB {
    ...
    public static void main(String[] args) {
		...
		System.out.println("5 - consultar quantos valores significativos já ocupam o vetor");
                ...
                System.out.println("9 - consultar busca binária (recursividade)");
                System.out.println("10 - consultar comparação (sequencial e binária) - apresentar o número total de comparações realizado até o resultado da consulta ( encontrado ou não, o valor ).");
